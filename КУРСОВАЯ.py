...
def city_message(callback):
    if callback.data == 'Погода':
        ...
        item3 = types.InlineKeyboardButton(text='IT', callback_data='новости', url='https://devby.io')
        item5 = types.InlineKeyboardButton(text='Авто!', callback_data='новости авто', url='https://cars.av.by/')
        item4 = types.InlineKeyboardButton(text='Назад', callback_data='назад')
        markup.row(item3, item5)
        markup.add(item4)
